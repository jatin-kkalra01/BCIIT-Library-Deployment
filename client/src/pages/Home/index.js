        ...
        {books.map((book) => {
          return (
            ...
            >
              ...
              >
                <div className="rounded bg-white p-2 shadow flex flex-column gap1 cursor-pointer">
                  <img src={book.image} height="350px"  />
                  <h1 className="text-md text-secondary uppercase font-bold mt-2 text-center">
                    {book.title}
                  </h1>
                </div>
              </Badge.Ribbon>
